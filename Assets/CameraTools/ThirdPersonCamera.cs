...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    [SerializeField, Min(0f)] private float automaticAlignDelay = 5f;
	...
	void LateUpdate () {
		...
		if (Physics.BoxCast(
			...
			lookRotation, castDistance, obstructionLayerMask
		)) {
	...
	bool AutomaticRotation () {
		if (Time.unscaledTime - lastManualRotationTime < automaticAlignDelay) {
			return false;
		}

		Vector3 alignedDelta = focusPoint - previousFocusPoint;
